...
# job_commute_time_rows = result['Metric_Name'] == 'Job Commute Time'
# # Ensure Travel_Time_Threshold is treated as string for manipulation
# result['Travel_Time_Threshold'] = result['Travel_Time_Threshold'].astype(str)
# # Update the Travel_Time_Threshold column for these rows
# result.loc[job_commute_time_rows, 'Travel_Time_Threshold'] = (
#     result.loc[job_commute_time_rows, 'Travel_Time_Threshold']
#     .str.split()
#     .str[-1]
# )
